...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("img/Left_Down_To_Right_Up.png", "img/Left_Down_To_Right_Up.png");
		type.set ("img/Left_Down_To_Right_Up.png", AssetType.IMAGE);
		path.set ("img/Left_Up_To_Right_Down.png", "img/Left_Up_To_Right_Down.png");
		type.set ("img/Left_Up_To_Right_Down.png", AssetType.IMAGE);
		path.set ("img/Right_Down_To_Left_Up.png", "img/Right_Down_To_Left_Up.png");
		type.set ("img/Right_Down_To_Left_Up.png", AssetType.IMAGE);
		path.set ("img/Right_Up_To_Down_Left.png", "img/Right_Up_To_Down_Left.png");
		type.set ("img/Right_Up_To_Down_Left.png", AssetType.IMAGE);
		
		
		#elseif html5
		
		var id;
		id = "img/Left_Down_To_Right_Up.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "img/Left_Up_To_Right_Down.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "img/Right_Down_To_Left_Up.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "img/Right_Up_To_Down_Left.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
